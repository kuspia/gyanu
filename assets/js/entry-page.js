...
import { formatDateKey, formatWakeTime, isValidDateKey, latestViewableDateKey } from './time.js';
...
function showMessage(title, message) {
  mount(slot, [
    el('div', { class: 'notice' }, [
      el('h2', { text: title }),
      el('p', { text: message }),
      el('a', { class: 'btn btn--ghost entry-back-button', href: 'index.html', text: 'Back to calendar' })
    ])
  ]);
}
